...
<body class="grayme is">
    ...
    <div class="columns fulllogin">
        <div class="column is-offset-1 is-half leftsideeffect">
            ...
            <div class="is-mobile textboxlogin">
                <p class="title has-text-black is-4 has-text-centered">Sign into your account</p>
                ...
                <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                    ...
                    <div class="field">
                        <p class="control has-icons-left">
                            <input
                                class="input {{ $errors->has('name') ? ' is-danger' : '' }} is-black inputline is-medium"
                    ...
                    <div class="field">
                        <p class="control has-icons-left has-icons-right">
                            <input
                                class="input {{ $errors->has('email') ? ' is-danger' : '' }} s-black inputline is-medium"
    ...
    <div class="field ">
        <p class="control has-text-centered is-centered loginbutton">
            <button type="submit" class="button is-black is full is-uppercase">
                &nbsp; &nbsp; &nbsp; &nbsp; Sign Up &nbsp; &nbsp; &nbsp; &nbsp;
            </button>
        </p>
    </div>
    ...
    <div class="column is-one-third rightsideeffect has-background-black">
        <div class="is-mobile textboxlogin textareabox">
            <p class="title has-text-white is-4 has-text-centered">Already have an account?</p>
            <p class="subtitle  has-text-white has-text-centered is-size-7 tinytextlogin">Click the button below to Sign In</p>
