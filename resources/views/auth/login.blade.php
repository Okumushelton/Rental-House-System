...
<head>
    ...
    <title>Login - RealProperty.lk</title>
...
<body class="grayme">
    ...
    <div class="columns fulllogin">
        <div class="column is-offset-1 is-half leftsideeffect">
            ...
            <div class="is-mobile textboxlogin">
                <p class="title has-text-black is-4 has-text-centered">DO YOU HAVE AN ACCOUNT?</p>
                <p class="subtitle  has-text-black has-text-centered is-size-7 tinytextlogin">Enter your email and password to login
                    your accoount.</p>
            </div>
            <div class="loginform">
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="field">
                        <p class="control has-icons-left has-icons-right">
                            <input
                                class="input {{ $errors->has('email') ? ' is-danger' : '' }} is-black inputline is-medium"
                    ...
                    <div class="field">
                        <p class="control has-icons-left">
                            <input
                                class="input {{ $errors->has('password') ? ' is-danger' : '' }} is-black inputline is-medium"
    ...
    <div class="field ">
        <p class="control has-text-centered is-centered loginbutton">
            <button class="button is-black is full is-uppercase">
                &nbsp; &nbsp; &nbsp; &nbsp; Sign in &nbsp; &nbsp; &nbsp; &nbsp;
            </button>
        </p>
    </div>
    ...
    <div class="column is-one-third rightsideeffect has-background-black">
        <div class="is-mobile textboxlogin textareabox">
            <p class="title has-text-white is-4 has-text-centered">Don't have an Account</p>
        ...
        <div class="is-centered has-text-centered">
            ...
            <a class="button is-inverted is-uppercase is-outlined signupbuttonloginpage" href="register">&nbsp; &nbsp;
                &nbsp; &nbsp; Sign Up &nbsp; &nbsp; &nbsp; &nbsp;</a>
