<div class="column displaybox">
        ...
        <nav class="breadcrumb has-arrow-separator profileback breadcrumbcss" aria-label="breadcrumbs">
            <ul>
                ...
                <li class="is-active"><a href="/profile">Edit apartment</a></li>
            </ul>
        </nav>
                                ...
                                <div class="control">
                                    ...
                                    <div class="select is-primary is-full">
                                        <select name="province">
                                            ...
                                            <option value="{{$apartment->property->province}}" selected>{{$apartment->property->province}}</option>
                                ...
                                <div class="control">
                                    ...
                                    <div class="contetnt">
                                        <div class="row columns">
                                                ...
                                                <div class="column"><img src="/uploads/property/apartment/{{$image}}" /></div>
                                                @endforeach
                                        </div>
                                    </div>
                                    <br>
