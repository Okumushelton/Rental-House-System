...
<head>
    ...
    <title>Contactus Rental Houses</title>
                ...
                <form action="/sendmessage" method="post">
                  @csrf
                    ...
                    <div class="field">
                      ...
                      <div class="control">
                        <textarea class="textarea is-info{{ $errors->has('message') ? ' is-danger' : '' }}" rows="8" name="message" placeholder="Enter your message"></textarea>
