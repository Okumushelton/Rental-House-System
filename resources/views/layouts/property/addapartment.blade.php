...
<body>
    ...
    <br>
    <div class="title has-text-centered">ADD APARTMENT</div>
    <br>
    <div class="container">
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <select name="province">
                                    <option value="West Lands">West lands</option>
                                    <option value="East Lands">East lands</option>
                ...
                <div class="column">
                    <div class="field">
                        <div class="control">
                            ...
                            <input class="input is-primary {{ $errors->has('rooms') ? ' is-danger' : '' }}" type="number"
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <input class="input is-primary {{ $errors->has('kitchen') ? ' is-danger' : '' }}" type="number"
                                name="kitchen" value="{{ old('kitchen') }}">
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <input class="input is-primary {{ $errors->has('washroom') ? ' is-danger' : '' }}" type="number"
                                name="washroom" value="{{ old('washroom') }}">
                    ...
                    <div class="field">
                        <div class="control">
                            ...
                            <input class="input is-primary {{ $errors->has('nrailway') ? ' is-danger' : '' }}" type="text"
                                name="nrailway" value="{{ old('nrailway') }}">
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCbOgBhAPNKgrV5SHmLFZIAzZRYGpsTJoU&libraries=places&callback=initAutocomplete"
        async defer></script>
